      ...
      <div className='container pb-24'>
        <div className='mt-6'>
          ...
          <div className='[&>h3]:step ml-4 border-l pl-8'>
            ...
            <Snippet>cd react-vite-boilerplate</Snippet>
        ...
        <div className='mt-12'>
          ...
          <ul className='ml-6 mt-4 list-disc'>
            <li className='mb-3'>
              <b>Vite</b>: Enjoy blazing fast build speeds and performance with
              Vite.
            </li>
            <li className='mb-3'>
              <b>React</b>: Leverage the power of React to build dynamic and
            ...
            <li className='mb-3'>
              <b>Shadcn</b>: Enhance your project with the sleek and modern
              shadcn component library.
            </li>
            <li className='mb-3'>
              <b>TypeScript</b>: Enjoy the benefits of static typing and
              improved developer experience with TypeScript.
            </li>
            <li className='mb-3'>
              <b>ESLint</b>: Keep your codebase clean and consistent with
              ESLint, ensuring high-quality code standards.
            </li>
            <li className='mb-3'>
            ...
            <li className='mb-3'>
              <b>SVGR</b>: Easily handle SVGs in your project with Vite and SVGR
              integration.
            </li>
            <li className='mb-3'>
              <b>Jest Testing Library React</b>: Write robust tests for your
              React components using the Jest testing library.
            </li>
            <li className='mb-3'>
